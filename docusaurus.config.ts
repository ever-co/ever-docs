...
const config: Config = {
  ...
  organizationName: 'ever-co', // Usually your GitHub org/user name.
  projectName: 'ever-docs', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © 2025-present. Ever Co. LTD.`,
    },
    prism: {
