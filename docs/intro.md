...
<details>
  ...
  ![Web Platform](https://docs.ever.team/web/overview.png)
  ![Web Platform](https://docs.ever.team/web/web2.png)
  ![Web Platform](https://docs.ever.team/web/web3.png)

  ### Mobile Apps (iOS/Android)

  ![Mobile Apps](https://docs.ever.team/mobile/overview.png)

  ### Browser Extension

  ![Browser Extension](https://docs.ever.team/extension/overview.png)
...
- **[Ever® Teams™ Platform Web Application](https://app.ever.team)**
- **[Ever® Teams™ Platform Demo Web Application](https://demo.ever.team)**
- **[Ever® Teams™ Platform Stage / Test Web Application](https://stage.ever.team)**
- **[Ever® Teams™ Platform Documentation](https://docs.ever.team)** (WIP)
- **[Official Ever® Teams™ Website](https://ever.team)** (WIP)  
  Learn more about the Ever® Teams™ platform.
- **[Ever® Gauzy™ Platform](https://gauzy.co)**  
  Discover more about the Ever® Gauzy™ platform.
- **[Ever® Company Products](https://ever.co)**  
  Explore our full range of products.

## ⚡️ Our Open Platforms

[Ever® Teams™ Platform](https://app.ever.team) is built on top of our Business Management Platform (ERP/CRM/HRM) — [Ever® Gauzy™ Platform](https://gauzy.co), which is part of our larger Open Platform for On-Demand and Sharing Economies — **Ever®**.  

For more details about all our products, visit **[ever.co](https://ever.co)**.
...
- [shadcn/ui](https://ui.shadcn.com), [Radix](https://www.radix-ui.com), and [Headless UI](https://headlessui.com)  

### Hosting  
- [DigitalOcean](https://www.digitalocean.com)  
- [Vercel](https://vercel.com)  

📌 *See also* `README.md` *and* `CREDITS.md` *in relevant folders for lists of included libraries, licenses, and additional details.*
...
[https://app.ever.team](https://app.ever.team)
...
- Open [http://localhost:3030](http://localhost:3030) in your browser, register a new account, and start using Ever Teams!
- Enjoy!
...
- _By default, Ever Teams web frontend will be connected to our production [Ever Gauzy API](https://github.com/ever-co/ever-gauzy) API endpoint [https://api.ever.team](https://api.ever.team). You can change it in environment variables `GAUZY_API_SERVER_URL` and `NEXT_PUBLIC_GAUZY_API_SERVER_URL`, see more in the section about how to run with a Self-hosted Backend._
...
- You can run [https://hub.docker.com/r/everco/ever-teams-webapp](https://hub.docker.com/r/everco/ever-teams-webapp) docker image with the following command: `docker run -p 127.0.0.1:3030:3030/tcp everco/ever-teams-webapp`. 
- Open [http://localhost:3030](http://localhost:3030) in your browser, register a new account, and start using Ever Teams!
...
_Note: By default, Ever Teams web frontend will be connected to our production [Ever Gauzy API](https://github.com/ever-co/ever-gauzy) API endpoint [https://api.ever.team](https://api.ever.team). You can change it in environment variables `GAUZY_API_SERVER_URL` and `NEXT_PUBLIC_GAUZY_API_SERVER_URL`, see more in the section about how to run with a Self-hosted Backend._

#### Images

We have Ever Teams Docker images published into:
- [Docker Hub - Everco](https://hub.docker.com/u/everco?page=1&search=ever-teams)
- [GitHub Packages - Everco](https://github.com/orgs/ever-co/packages?tab=packages&q=ever-teams)
...
4. Open in [http://localhost:3030](http://localhost:3030) in your Browser

_Notes:_
- _By default, Ever Teams web frontend will be connected to our production [Ever Gauzy API](https://github.com/ever-co/ever-gauzy) API endpoint [https://api.ever.team](https://api.ever.team). You can change it in environment variables `GAUZY_API_SERVER_URL` and `NEXT_PUBLIC_GAUZY_API_SERVER_URL`, see below how to run with a Self-hosted Backend._

### Run with a Self-hosted Backend

1. Download and run the Ever Gauzy Server setup ([Download](https://gauzy.co/downloads)) or run the server manually (see [Server Setup](https://github.com/ever-co/ever-gauzy/tree/develop/apps/server)). You can also run only Ever Gauzy APIs (manually), see [API Setup](https://github.com/ever-co/ever-gauzy/tree/develop/apps/api). For getting started instructions, it's best to check the Ever Gauzy [README](https://github.com/ever-co/ever-gauzy/blob/develop/README.md) file.
2. Clone this repo
3. After you get the API or Server running, make sure you set the environment variables `GAUZY_API_SERVER_URL` and `NEXT_PUBLIC_GAUZY_API_SERVER_URL` in Ever Teams `.env` file (see [Sample `.env`](https://github.com/ever-co/ever-teams/blob/develop/web/.env.sample)). For example, you can set those env vars to [http://localhost:3000](http://localhost:3000) if Gauzy APIs run on that host & port.
4. Run `yarn install`
5. Run `yarn build:web && yarn start:web` OR `yarn start:web:dev`
6. Open in [http://localhost:3030](http://localhost:3030) in your Browser

#### Notes

Note: Ever® Teams™ requires access to Ever® Gauzy™ Platform APIs, provided by another project - Ever® Gauzy™ Platform, see [Ever Gauzy GitHub](https://github.com/ever-co/ever-gauzy) (and also [Gauzy Website](https://gauzy.co)). Specifically, you might be interested in the `apps/api` and `apps/server` folders of the mono-repo for the Gauzy API & Gauzy Server code.
...
- `/apps/web` - NextJs-based (React) Web App at [https://app.ever.team](https://app.ever.team) (deployed from `main` branch)
...
- `/apps/extensions` - Browser Extensions (powered by [PlasmoHQ](https://github.com/PlasmoHQ/plasmo))
...
- For business inquiries: [gauzy@ever.co](mailto:gauzy@ever.co)
- Please report security vulnerabilities to [security@ever.co](mailto:security@ever.co)
...
If you discover any issue regarding security, please disclose the information responsibly by emailing [security@ever.co](mailto:security@ever.co) and not by creating a GitHub issue.
...
[![Powered by DigitalOcean](https://opensource.nyc3.cdn.digitaloceanspaces.com/attribution/assets/PoweredByDO/DO_Powered_by_Badge_blue.svg)](https://www.digitalocean.com/?utm_medium=opensource&utm_source=ever-co)

<!-- [![Powered by Vercel](https://raw.githubusercontent.com/ever-co/ever-teams/main/static/img/vercel-logo.svg)](https://vercel.com/?utm_source=ever-co&utm_campaign=oss) -->
## ©️ Copyright
